import msg91Dataset, { getStream, MSG91_DATASET_ID, MSG91_PROJECT_ID, writeClient, mode, VOICE_REP_TABLE_ID } from "../database/big-query-service";
import logger from "../logger/logger";
import { Table } from '@google-cloud/bigquery';
import protoDescriptor from "./protofiles/voiceReport_descriptor";


const voiceReportTable: Table = msg91Dataset.table(VOICE_REP_TABLE_ID);
...
export default class VoiceReport {
  ...
  public static async newInsertMany(voiceReports: Array<VoiceReport>) {
    try {
