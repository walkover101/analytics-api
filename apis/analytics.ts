...
// POST '/analytics/sms/export' | '/analytics/mail/export' | '/analytics/otp/export'
router.post(/^\/(sms|mail|otp)\/export\b/, downloadsController.downloadCsv(REPORT_TYPE.ANALYTICS));

// GET '/analytics/sms/export' | '/analytics/mail/export' | '/analytics/otp/export'
router.get(/^\/(sms|mail|otp)\/export\b/, downloadsController.getDownloadLinks(REPORT_TYPE.ANALYTICS));
