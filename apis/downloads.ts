...
router.post(/^\/(sms|otp|mail|wa)/, downloadsController.downloadCsv(REPORT_TYPE.LOGS));

// GET '/exports' | '/exports/sms' | '/exports/otp' | '/exports/mail' | '/exports/wa'
router.get(/^\/($|sms|otp|mail|wa)/, downloadsController.getDownloadLinks(REPORT_TYPE.LOGS));
